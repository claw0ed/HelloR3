...
barplot(as.matrix(fruits), main='과일 섭취량',
        ylab='섭취량', xlab='과일', col=rainbow(5), ylim=c(0, 700))

barplot(as.matrix(fruits), main='과일 섭취량',
        ylab='섭취량', xlab='과일', col=rainbow(5), beside=T, ylim=c(0, 250))
...
# 박스 수염 그래프 - boxplot
# 중앙값, 평균, 사분위수등과 깉은 주요 통계 측정치를 시각화
